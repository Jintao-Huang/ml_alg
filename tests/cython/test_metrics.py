...
if __name__ == "__main__":
    ...
    y = ml.test_time(lambda: _spearman_corrcoef(preds, target), 1, 1, ml.time_synchronize)
    y2 = ml.test_time(lambda: libs_ml.spearman_corrcoef(preds, target), 1, 1, ml.time_synchronize)
