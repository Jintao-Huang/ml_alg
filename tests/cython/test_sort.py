...
if __name__ == "__main__":
    ...
    ml.test_time(lambda: libs_algf.partition_cy(x.copy()))  # fast
    ml.test_time(lambda: libs_algf.quick_sort_cy(x.copy()), 1, 1)  # fast
    ml.test_time(lambda: libs_algf.merge_sort_cy(x.copy()), 1, 1)  # fast
