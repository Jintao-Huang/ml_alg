...
ldm = libs_ml.LDataModule(
    train_dataset, val_dataset, test_dataset, batch_size_train=32, num_workers=4)
...
if __name__ == "__main__":
    ...
    hparams = {
        ...
        "trainer_hparams": {"max_epochs": max_epochs, "gradient_clip_norm": 5},
        "lrs_hparams": {"warmup": 500, "T_max": len(ldm.train_dataloader) * max_epochs}
    }
