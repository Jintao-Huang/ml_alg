...
if __name__ == "__main__":
    ...
    hparams = {
        ...
        "optim_name": "AdamW",
        "dataloader_hparams": {"batch_size_train": 8, "num_workers": 4, "collate_fn": data_collator},
        "optim_hparams": {"lr": 5e-5, "weight_decay": 1e-4},  #
        "trainer_hparams": {"max_epochs": 3, "gradient_clip_norm": 5},
        "lrs_hparams": {...}
    }
    ldm = libs_ml.LDataModule(
        dataset["train"], dataset["validation"], dataset["test"], **hparams["dataloader_hparams"])
    hparams["lrs_hparams"] = {"warmup": 200,
